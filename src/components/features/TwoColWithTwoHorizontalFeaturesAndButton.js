...
const Features = tw.div`flex flex-wrap flex-row sm:max-w-2xl lg:max-w-5xl mx-auto`;
// const Feature = tw.div`mt-10 lg:mt-8 flex items-center md:items-start flex-col md:mr-8 last:mr-0`;
const Feature = tw.div`mt-12 w-full sm:w-1/2 lg:w-1/2 flex flex-col`;

const FeatureHeadingContainer = tw.div`flex`;
const FeatureIconContainer = styled.div`
  ${tw`inline-block border border-primary-500 text-primary-500 rounded p-2 flex-shrink-0`}
  ${props => [
